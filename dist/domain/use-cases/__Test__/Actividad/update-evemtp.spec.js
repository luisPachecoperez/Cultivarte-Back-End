...
const update_evento_1 = require("../../Actividad/update-evento");
describe('UpdateActividadUseCaseImpl', () => {
    const actividadRepository = {
        updateById: jest.fn(),
    };
    const useCase = new update_evento_1.UpdateActividadUseCaseImpl(actividadRepository);
    const mockActividad = {
    ...
    it('actualiza actividad correctamente', async () => {
        ...
        expect(actividadRepository.updateById).toHaveBeenCalledWith('1', mockActividad);
    ...
    it('propaga errores si ocurren', async () => {
        ...
        await expect(useCase.execute('1', mockActividad)).rejects.toThrow('DB error');
    });
});
//# sourceMappingURL=update-evemtp.spec.js.map