describe('CreateParametroDetalleUseCaseImpl', () => {
    ...
    beforeEach(() => {
        ...
        useCase =
            new (require('../../parametro-detalle/create-parametro-detalle').CreateParametroDetalleUseCaseImpl)(parametroDetalleRepository);
    });
    it('should call repository.create with the correct parametroDetalle', async () => {
        ...
        expect(parametroDetalleRepository.create).toHaveBeenCalledWith(parametroDetalleMock);
    });
