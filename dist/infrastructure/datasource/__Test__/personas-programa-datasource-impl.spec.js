...
const personas_programa_datasource_impl_1 = require("../personas-programa-datasource-impl");
...
describe('PersonasProgramaDataSourceImpl', () => {
    let dataSource;
    beforeEach(() => {
        dataSource = new personas_programa_datasource_impl_1.PersonasProgramaDataSourceImpl();
        jest.clearAllMocks();
    });
    it('getAll retorna lista correctamente', async () => {
        pg_pool_1.pgPool.query.mockResolvedValue({ rows: [{ id_persona_programa: '1' }] });
    ...
    it('create retorna éxito correctamente', async () => {
        ...
        const result = await dataSource.create(personaPrograma);
    ...
    it('updateById retorna éxito correctamente', async () => {
        ...
        const result = await dataSource.updateById('1', personaPrograma);
        expect(result.exitoso).toBe('S');
...
//# sourceMappingURL=personas-programa-datasource-impl.spec.js.map