...
const personas_grupo_interes_datasource_impl_1 = require("../personas-grupo-interes-datasource-impl");
...
describe('PersonasGrupoInteresDataSourceImpl', () => {
    let dataSource;
    beforeEach(() => {
        dataSource = new personas_grupo_interes_datasource_impl_1.PersonasGrupoInteresDataSourceImpl();
        jest.clearAllMocks();
    });
    it('create retorna éxito correctamente', async () => {
        ...
        const result = await dataSource.create(persona);
    ...
    it('updateById retorna éxito correctamente', async () => {
        ...
        const persona = { id_persona: '1' };
        const result = await dataSource.updateById('1', persona);
        expect(result.exitoso).toBe('S');
    ...
    it('getAll retorna lista correctamente', async () => {
        pg_pool_1.pgPool.query.mockResolvedValue({ rows: [{ id_persona_grupo_interes: '1' }] });
...
//# sourceMappingURL=personas-grupo-interes-datasource-impl.spec.js.map