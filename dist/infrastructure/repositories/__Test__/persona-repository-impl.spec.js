...
const persona_repository_impl_1 = require("../persona-repository-impl");
describe('PersonaRepositoryImpl', () => {
    ...
    beforeEach(() => {
        ...
        repo = new persona_repository_impl_1.PersonaRepositoryImpl(mockDataSource);
    });
    ...
    it('createPersona retorna resultado del datasource', async () => {
        ...
        const result = await repo.createPersona({ id_persona: 'p1' });
        expect(result).toHaveProperty('id_persona', 'p1');
    });
    ...
    it('updatePersona retorna resultado del datasource', async () => {
        ...
        const result = await repo.updatePersona('p1', { id_persona: 'p1' });
        expect(result).toHaveProperty('id_persona', 'p1');
    });
...
//# sourceMappingURL=persona-repository-impl.spec.js.map