...
const options = {
    definition: {
        ...
        tags: [
            ...
            {
                name: 'Sesiones Asistentes',
                description: 'Operaciones con sesiones asistentes',
            },
            { name: 'Usuarios', description: 'Operaciones con usuarios' },
            {
                name: 'Parámetros Generales',
                description: 'Operaciones con parámetros generales',
            },
            {
                name: 'Parámetros Detalle',
                description: 'Operaciones con parámetros de detalle',
            },
        ],
        paths: {
            '/graphql': {
