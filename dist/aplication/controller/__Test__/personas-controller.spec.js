...
describe('PersonasController', () => {
    ...
    it('createPersona - success', async () => {
        ...
        await expect(controller.createPersona(mockPersona)).resolves.toBe(mockPersona);
    ...
    it('createPersona - error', async () => {
        ...
        await expect(controller.createPersona(mockPersona)).resolves.toBe(mockRespuesta);
    });
    it('updatePersona - success', async () => {
        updatePersonaUseCase.execute.mockResolvedValueOnce(mockPersona);
        await expect(controller.updatePersona('1', mockPersona)).resolves.toBe(mockPersona);
    ...
    it('updatePersona - error', async () => {
        ...
        await expect(controller.updatePersona('1', mockPersona)).resolves.toBe(mockRespuesta);
    });
    ...
    it('getAliadosSede - error', async () => {
        ...
        await expect(controller.getAliadosSede('user')).resolves.toBe(mockRespuesta);
    });
    ...
    it('getBenSedes - error', async () => {
        ...
        await expect(controller.getBenSedes()).resolves.toBe(mockRespuesta);
    });
});
//# sourceMappingURL=personas-controller.spec.js.map