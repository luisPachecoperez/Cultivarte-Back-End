import { DeletePersonaGrupoInteresUseCase,
...
export class PersonasGruposInteresController {
    ...
    async getPersonaGrupoInteresById( id_persona_grupo_interes: string ): Promise<PersonaGrupoInteres | RespuestaGrap> {
        return this.getPersonaGrupoInteresByIdUseCase.execute( id_persona_grupo_interes );
    }

    async getPersonasGrupoInteres(): Promise<PersonaGrupoInteres[] | RespuestaGrap> {
        return this.getPersonasGrupoInteresUseCase.execute();
    }

    async createPersonaGrupoInteres( personaGrupoInteres: PersonaGrupoInteres ): Promise<RespuestaGrap> {
        return this.createPersonaGrupoInteresUseCase.execute( personaGrupoInteres );
    }

    async updatePersonaGrupoInteres( id_persona_grupo_interes: string, personaGrupoInteres: PersonaGrupoInteres ): Promise<RespuestaGrap> {
        return this.updatePersonaGrupoInteresUseCase.execute( id_persona_grupo_interes, personaGrupoInteres );
    }

    async deletePersonaGrupoInteres( id_persona_grupo_interes: string ): Promise<RespuestaGrap> {
