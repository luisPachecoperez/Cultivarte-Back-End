...
export class PersonasSedesController {
    ...
    async create( personaSede: PersonasSede ): Promise<PersonasSede | RespuestaGrap> {
        return this.createPersonaSedeUseCase.execute( personaSede );
    }
    
    async update( id_sede: string, personaSede: PersonasSede ): Promise<PersonasSede | RespuestaGrap> {
