...
export class AsistenciasController {
    ...
    async getAsistencia( id_asistencia: string ): Promise<Asistencia | RespuestaGrap> {
    ...
    async updateAsistencia( id_asistencia: string, asistencia: Asistencia ): Promise<RespuestaGrap> {
