import { CreateParametroDetalleUseCaseImpl } from '../create-parametro-detalle';

describe('CreateParametroDetalleUseCaseImpl', () => {
  let repo: any;
  let useCase: CreateParametroDetalleUseCaseImpl;

  beforeEach(() => {
    repo = { create: jest.fn() };
    useCase = new CreateParametroDetalleUseCaseImpl(repo);
  });
