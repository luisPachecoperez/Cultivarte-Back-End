...
export class PersonasGrupoInteresRepositoryImpl
  implements PersonasGruposInteresRepository
{
  constructor(
  ...
  async getById(
    ...
    return this.personasGrupoInteresDataSource.getById(
  ...
  async updateById(
    ...
    return this.personasGrupoInteresDataSource.updateById(
      id_persona_grupo_interes,
      personaGrupoInteres,
    );
  }
  ...
  async deleteById(id_persona_grupo_interes: string): Promise<RespuestaGrap> {
    return this.personasGrupoInteresDataSource.deleteById(
      id_persona_grupo_interes,
    );
  }
}
