...
export class ActividadRepositoryImpl implements ActividadRepository {
  constructor(private readonly actividadDataSource: ActividadDataSource) {}
  ...
  async getPreEditActividad(
    ...
    try {
      return await this.actividadDataSource.getPreEditActividad(
        id_actividad,
        id_usuario,
      );
    } catch (error: unknown) {
  ...
  async createActividadAndSesiones(
    ...
    try {
      return await this.actividadDataSource.createActividadAndSesiones(
        actividad,
      );
    } catch (error: unknown) {
      return {
