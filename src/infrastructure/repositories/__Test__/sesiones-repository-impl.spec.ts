import { SesionesRepositoryImpl } from '../sesiones-repository-impl';
import { SesionesDataSource, Sesion, EditarSesiones, RespuestaGrap } from '../../../domain';

describe('SesionesRepositoryImpl', () => {
  let dataSource: jest.Mocked<SesionesDataSource>;
  let repo: SesionesRepositoryImpl;
  ...
  beforeEach(() => {
    ...
    repo = new SesionesRepositoryImpl(dataSource);
  });

  const sesion: Sesion = { id: '1', nombre: 'Test' } as any;
  const editarSesiones: EditarSesiones = { id: '1', cambios: [] } as any;
