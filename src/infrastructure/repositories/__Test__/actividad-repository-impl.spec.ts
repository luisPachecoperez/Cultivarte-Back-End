import { ActividadRepositoryImpl } from '../actividad-repository-impl';

describe('ActividadRepositoryImpl', () => {
  let repo: ActividadRepositoryImpl;
  ...
  beforeEach(() => {
    ...
    repo = new ActividadRepositoryImpl(mockDataSource);
  });
  ...
  it('createActividadAndSesiones retorna resultado del datasource', async () => {
    ...
    const result = await repo.createActividadAndSesiones({} as any);
    expect(result).toBe('ok');
  });
  ...
  it('createActividad retorna resultado del datasource', async () => {
    ...
    const result = await repo.createActividad({} as any);
    expect(result).toBe('ok');
  });
  ...
  it('updateById retorna resultado del datasource', async () => {
    ...
    const result = await repo.updateById('a1', {} as any);
    expect(result).toBe('ok');
  });
