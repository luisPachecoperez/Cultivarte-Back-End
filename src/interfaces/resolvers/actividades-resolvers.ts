...
export const actividadesResolvers = {
  ...
  Mutation: {
    createActividadAndSesiones: (_: any, args: { data: Actividad }) =>
      controller.createActividadAndSesiones(args.data),
    createActividad: (_: any, args: { data: Actividad }) =>
      controller.createActividad(args.data),
    updateActividad: (
      _: any,
      args: { id_actividad: string; data: Actividad },
    ) => controller.updateActividad(args.id_actividad, args.data),
