...
const controller = new PersonasProgramaController(useCaseCreate,useCaseUpdate,useCaseDelete,useCaseGetById,useCaseGetAll); 

export const personasProgramaResolvers = {
    Query: {
        getPersonaProgramaById: (_: any, args: { id_persona_programa: string }) => controller.getPersonaPrograma(args.id_persona_programa),
        getPersonaProgramas: (_: any) => controller.getPersonasPrograma(),
    },
    Mutation: {
        createPersonaPrograma: (_: any, args: { personaPrograma: PersonaPrograma }) => controller.createPersonaPrograma(args.personaPrograma),
        updatePersonaPrograma: (_: any, args: { id_persona_programa: string, personaPrograma: PersonaPrograma }) => controller.updatePersonaPrograma(args.id_persona_programa, args.personaPrograma),
        deletePersonaPrograma: (_: any, args: { id_persona_programa: string }) => controller.deletePersonaPrograma(args.id_persona_programa),
    },
};
