import {
  GetParametroGeneralUseCaseImpl,
...
export const parametrosGeneralesResolvers = {
  Query: {
    ...
    getParametroGeneral: (_: any, args: { id: string }) =>
      controller.getParametroGeneral(args.id),
  },
  Mutation: {
    createParametroGeneral: (_: any, args: { data: ParametrosGenerales }) =>
      controller.createParametroGeneral(args.data),
    updateParametroGeneral: (
      _: any,
      args: { id: string; data: ParametrosGenerales },
    ) => controller.updateParametroGeneral(args.id, args.data),
    deleteParametroGeneral: (_: any, args: { id: string }) =>
      controller.deleteParametroGeneral(args.id),
  },
};
