import { CreateEventoUseCaseImpl,
         DeleteEventoUseCaseImpl,
         Evento,
         GetEventosUseCaseImpl,
         GetEventoUseCaseImpl,
         UpdateEventoUseCaseImpl } from '../../domain';
...
export const eventosResolvers = {
    ...
    Mutation: {
        ...
        updateEvento: (_: any, args: { id: string, data: Evento }) => controller.updateEvento( args.id, args.data ),
