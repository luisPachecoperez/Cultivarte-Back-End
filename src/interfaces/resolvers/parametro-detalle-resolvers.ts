import { GetParametroDetalleUseCaseImpl, 
...
const controller = new ParametrosDetalleController( useCaseCreate, useCaseGetAll, useCaseGetById, useCaseUpdate, useCaseDelete );
...
export const parametroDetalleResolvers = {
    ...
    Mutation: {
      ...
      updateParametroDetalle: (_: any, args: { id:string, data:ParametroDetalle }) => controller.updateParametroDetalle( args.id, args.data ),
      deleteParametroDetalle: (_: any, args: { id:string }) => controller.deleteParametroDetalle( args.id )
    }
};